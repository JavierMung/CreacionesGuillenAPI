                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <div className="text-start">
                            ...
                            <input name={'cantidad'} onChange={(e) => handleChange(id, e)} class="form-control" placeholder="Ejem. 300" type={"number"} />
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="text-start">
                            <label className='form-label'>Encargado</label>
                            <select name={'encargado'} onChange={(e) => handleChange(id, e)} class="form-select" aria-label="Default select example" disabled={!active}>
