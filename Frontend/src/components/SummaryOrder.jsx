function SummaryOrder({ listaProductos, formatterDolar, eliminarProducto, total }) {
    return (
                    ...
                    listaProductos && listaProductos.map((pro, index) => {
                        return (
                            <tr key={index} className="align-middle">
                                <th scope="row">{pro.nombreProducto}<p>{pro.descripcion}</p></th>
                                ...
                                <td>
                                    <button className="btn " onClick={() => eliminarProducto(pro.numeroProducto)}>
