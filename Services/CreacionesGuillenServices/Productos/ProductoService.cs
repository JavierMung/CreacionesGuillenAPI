...
namespace webAPI.Services.CreacionesGuillenServices
{
    public class ProductoService : IProductoService
    {
        ...
        public async Task<ProductoView?> GetProducto(int id)
        {
            ...
            return new ProductoView(producto.IdProducto, producto.Nombre ?? "Sin Nombre", producto.Cantidad ?? 0, producto.Precio ?? 0m);
        }
        ...
        private async Task<List<ProductoView>> obtenerLista()
        {
            ...
            {
                productos.Add(new ProductoView(producto.IdProducto, producto.Nombre ?? "Sin Nombre", producto.Cantidad ?? 0, producto.Precio ?? 13.50m));
            }
            return productos;
        }
